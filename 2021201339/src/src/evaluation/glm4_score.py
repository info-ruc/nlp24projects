...
def chat_gpt(messages, counter, error_count):
    ...
    for i, m in enumerate(messages):
        try:
            ...
            m['response'] = res.choices[0].message.content
            # save to file
...
def get_messages_list(task_name, input_file_a, input_file_b, output_file):
...
if __name__ == '__main__':
    ...
    if not os.path.exists(output_file):
        ...
        x.close()
    messages_list = get_messages_list(task_name, input_file_a, input_file_b, output_file)
