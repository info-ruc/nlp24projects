...
__model_path__ = {
    ...
    'Llama-2-7b-chat-hf':{
        'model_type': 'llama',
        'model_name_or_path': '/workspace/robotics/MODELS/shakechen/Llama-2-7b-hf',
        'config_name': '/workspace/robotics/MODELS/shakechen/Llama-2-7b-hf/config.json',
        'tokenizer_name': '/workspace/robotics/MODELS/shakechen/Llama-2-7b-hf',
    },
