...
os.environ["WANDB_API_KEY"] = 'local-32650cee3b136073eddc00faa1b4b35876e31b80'
...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project='bpo', name='dpo_training')
